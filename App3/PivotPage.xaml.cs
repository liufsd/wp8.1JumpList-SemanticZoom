...
namespace App3
{
    public sealed partial class PivotPage : Page
    {
        ...
        public PivotPage()
        {
            ...
            ls.Add(new HouseGuest() { FirstName = "Tss", LastName = "Haynes", Role = "Coach" });
            ls.Add(new HouseGuest() { FirstName = "fdsfd", LastName = "Haynes", Role = "Coach" });
            ls.Add(new HouseGuest() { FirstName = "fdsf", LastName = "Terry", Role = "Player" });
            ls.Add(new HouseGuest() { FirstName = "Iaccn", LastName = "Terry", Role = "Player" });
            ls.Add(new HouseGuest() { FirstName = "cd", LastName = "Terry", Role = "Player" });
            ls.Add(new HouseGuest() { FirstName = "Iadfdsfaan", LastName = "Terry", Role = "Player" });
        ...
        private void MyTest_ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
           /* var selectName = ((HouseGuest) e.ClickedItem).FirstName;
            Debug.WriteLine(selectName);*/
        }
